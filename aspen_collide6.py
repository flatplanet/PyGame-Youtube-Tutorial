...
class Game():
	def __init__(self, aspen_group, food_group):
		...
		blue_food = pygame.image.load("images/food2.png")
		red_food = pygame.image.load("images/food.png")

		# Add food to our food group
		# Food Type: 0=blue, 1=red
		self.food_group.add(Food(190,200, red_food, 1))
		for i in range(7):
			self.food_group.add(Food(i*100,200, blue_food, 0))
