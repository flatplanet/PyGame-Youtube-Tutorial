...
hero_left_rect.center = (WINDOW_WIDTH//2, WINDOW_HEIGHT//2)
...
while running:
	...
	# Draw some rects
	#pygame.draw.rect(screen, "red", hero_right_rect, 1)
	#pygame.draw.rect(screen, "green", hero_left_rect, 1)
	...
	if hero_right_rect.colliderect(hero_left_rect):
		# Push image
		# hero_left_rect.x += 300 * dt
		# Remove the Image 
		# hero_left.fill(0)
		# Randomly Move Image
		hero_left_rect.x = random.randint(0, WINDOW_WIDTH - 54)
		hero_left_rect.y = random.randint(0, WINDOW_HEIGHT - 66)
